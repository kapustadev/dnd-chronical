    ...
    <div className={`header-wrapper ${menuOpen ? 'nav-active' : ''}`}>
      ...
      <div className="main-nav">
        <div className="logo-container" onClick={() => handleNav('home')}>
          <img src={currentSystem.includes('Pathfinder') ? '/pathfinder-seeklogo.svg' : '/DnD-Symbol.png'} alt={currentSystem} className="logo-image" style={{ objectPosition: 'top', height: currentSystem.includes('Pathfinder') ? '24px' : 'auto', width: currentSystem.includes('Pathfinder') ? '140px' : '40px' }} />
    ...
    <div className="footer-grid">
      <div className="footer-column">
        <h4 style={{ color: 'var(--text-main)', display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
          <img src={currentSystem?.includes('Pathfinder') ? '/pathfinder-seeklogo.svg' : '/DnD-Symbol.png'} style={{ height: '24px', width: currentSystem?.includes('Pathfinder') ? '100px' : '24px', objectFit: 'contain' }} alt={currentSystem || "D&D"} /> Chronicle
        </h4>
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '80vh', padding: '1rem' }}>
      <form onSubmit={submit} style={{ background: 'var(--bg-card)', border: '1px solid var(--border-color)', borderRadius: 'var(--border-radius-large)', padding: '2rem', width: '100%', maxWidth: '340px', textAlign: 'center' }}>
        <img src={currentSystem?.includes('Pathfinder') ? '/pathfinder-seeklogo.svg' : '/DnD-Symbol.png'} alt={currentSystem || "D&D"} style={{ height: currentSystem?.includes('Pathfinder') ? '40px' : '60px', width: currentSystem?.includes('Pathfinder') ? '180px' : 'auto', margin: '0 auto 1rem', display: 'block', objectFit: 'contain' }} />
  ...
  if (authLoading) return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh' }}>
      <div style={{ textAlign: 'center' }}>
        <img src={currentSystem?.includes('Pathfinder') ? '/pathfinder-seeklogo.svg' : '/DnD-Symbol.png'} alt={currentSystem || "D&D"} style={{ height: currentSystem?.includes('Pathfinder') ? '40px' : '60px', width: currentSystem?.includes('Pathfinder') ? '180px' : 'auto', marginBottom: '1rem', opacity: 0.6, objectFit: 'contain' }} />
