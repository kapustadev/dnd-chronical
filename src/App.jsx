...
const PricingPage = ({ setView }) => (
  <section className="section-wrapper">
    ...
    <div className="grid-3" style={{ maxWidth: '80%', margin: '0 auto' }}>
...
const FaqPage = () => {
  ...
  return (
    <section className="section-wrapper" style={{ maxWidth: '80%', margin: '0 auto' }}>
...
const ContactPage = () => (
  <section className="section-wrapper" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
    <div style={{ background: 'var(--bg-card)', padding: '2.5rem', borderRadius: 'var(--border-radius-large)', border: '1px solid var(--border-color)', width: '100%', maxWidth: '80%' }}>
